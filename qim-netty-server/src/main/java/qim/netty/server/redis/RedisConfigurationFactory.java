...
public class RedisConfigurationFactory {
    ...
    private static final String DEFAULT_REDIS_CONFIG = "redis.properties";
    ...
    public static RedisConfiguration parseConfiguration() throws Exception {
        ...
        if (standardClassloader != null) {
            url = standardClassloader.getResource(DEFAULT_REDIS_CONFIG);
        }
        if (url == null) {
        	//url = JimVersion.class.getResource(DEFAULT_REDIS_CONFIG);
        }
        if (url != null) {
